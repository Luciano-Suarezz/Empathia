      ...
      {Object.values(MacroType).map((macro) => {
        ...
        return (
          <button
            ...
            disabled={disabled}
            className={`
              flex-1 flex items-center justify-center gap-1.5 px-2 py-2 rounded-lg text-[10px] sm:text-xs font-black uppercase tracking-tight transition-all duration-200 option-btn
