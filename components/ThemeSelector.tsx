      ...
      <button
        ...
        className={`flex items-center gap-2 px-3 py-2 rounded-full transition-all border
          ${activeTheme !== 'original' 
            ...
            : 'bg-white dark:bg-slate-900 text-gray-700 dark:text-slate-300 border-gray-200 dark:border-slate-700'} hover:shadow-md`}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-800 rounded-xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden z-50"
          >
